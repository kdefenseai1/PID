...
`
    ...
    manual: {
      ...
      overviewDesc: "Project Face ID는 북한 고위급 인사 및 주요 요인에 대한 신속하고 정확한 신원 식별을 위해 개발된 전술 생체 인식 시스템입니다. 본 시스템은 작전 중 확보된 신병이나 감시 자산을 통해 획득한 대상의 안면 데이터를 분석하고, 기 구축된 북한 주요 인물 데이터베이스와 대조하여 피아 식별 및 대상의 정확한 신원을 확정하는 것을 주 목적으로 합니다.",
